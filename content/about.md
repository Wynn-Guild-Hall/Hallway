---
title: "About the Guild Hall"
description: "What the Wynncraft Guild Hall is, who it's for, and how representation works."
---

The **Wynncraft Guild Hall** is a shared clearinghouse within which ownership of
major Wynncraft guilds can discuss and coordinate. It will also be home to some
joint projects in the near future, including an updated guild recruiting list
and a build server.

Membership in this platform does not imply endorsement of any guild — it exists
to make inter-guild communication easier.

## Who is it for?

Founders of major Wynncraft guilds, and the leaders of those same guilds'
warring, housing, and event efforts.

## How representation works

Each major guild is represented by up to four **contact roles**. One person can
hold more than one, and a guild does not have to fill all of them:
...
Head over to [**Join**](/join/) to check your username and get your code.
